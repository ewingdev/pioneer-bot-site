...
export default function AwardApp({ Component, pageProps }) {
  ...
  const NavItems = [
    ...
    },
    {
      ...
      href: "https://discord.gg/nykaaGCEuA",
    },
    {
      link: true,
      name: "Botu Ekle",
      ...
      href: "https://discord.com/api/oauth2/authorize?client_id=873192637438496768&permissions=8&scope=bot%20applications.commands",
    },
       {
      link: true,
      name: "Vote",
      ...
      href: "https://top.gg/bot/873192637438496768/vote",
    },
    {
      link: true,
      name: "Partnerler",
